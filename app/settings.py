...
enable_update_deployment = app.config.get('FEATURE_UPDATE_DEPLOYMENT') \
  if app.config.get('FEATURE_UPDATE_DEPLOYMENT') else "no"
hidden_deployment_columns = app.config.get('FEATURE_HIDDEN_DEPLOYMENT_COLUMNS') \
  if app.config.get('FEATURE_HIDDEN_DEPLOYMENT_COLUMNS') else ""
